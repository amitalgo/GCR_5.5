...
">
    ...
    <!--Form Wizard-->
    <link href="<?php echo e(asset('plugins/summernote/dist/summernote.css')); ?>" rel="stylesheet" />
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('plugins/jquery.steps/demo/css/jquery.steps.css')); ?>" />
    <link href="<?php echo e(asset('plugins/select2/select2.css')); ?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo e(asset('plugins/datatables/jquery.dataTables.min.css')); ?>" rel="stylesheet" type="text/css" />
    <link type="text/css" href="<?php echo e(asset('plugins/x-editable/dist/bootstrap3-editable/css/bootstrap-editable.css')); ?>" rel="stylesheet">

    <link href="<?php echo e(asset('plugins/custombox/dist/custombox.min.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('plugins/footable/css/footable.core.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('plugins/bootstrap-select/dist/css/bootstrap-select.min.css')); ?>" rel="stylesheet" />
    ...
    <link href="<?php echo e(asset('css/css/core.css')); ?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo e(asset('css/css/components.css')); ?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo e(asset('css/css/icons.css')); ?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo e(asset('css/css/pages.css')); ?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo e(asset('css/css/responsive.css')); ?>" rel="stylesheet" type="text/css" />
    ...
    <script src="<?php echo e(asset('js/js/modernizr.min.js')); ?>"></script>
    <style type="text/css">
        .delItemIcon
        {
