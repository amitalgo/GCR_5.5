                            ...
                            <a href="<?php echo e(route('solution.products',['id'=>$tagCategory->getScenarioId()->getId()])); ?>">
                                <div class="col-md-4 col-md-12">
                                    <div class="solInerTab">
                                        <div class="divImg"><img src="<?php echo e($tagCategory->getScenarioId()->getScenarioImg()); ?>" class="img-responsive" alt="solution-1"></div>            <h1><?php echo e($tagCategory->getScenarioId()->getName()); ?></h1>
