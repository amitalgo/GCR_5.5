            ...
            <div class="col-sm-12">
                <div class="card-box">
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $product->getProductInquiryId(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productInquiry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td class="editTd"><?php echo e($productInquiry->getAddDate()); ?></td>
                                <td class="editTd"></td>
                            </tr>
