                            ...
                            <div class="col-md-6">
                                    ...
                                    <select class="form-control select2" multiple="multiple" name="pages[]" required="required"\>
                                        ...
                                        <?php $__currentLoopData = $pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($page->getId()); ?>" <?php if(isset($news)): ?> <?php echo in_array($page->getId(),$news->getSelectedPages())?'selected':'' ?>  <?php endif; ?>><?php echo e($page->getName()); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                            </div>
                        </div>
