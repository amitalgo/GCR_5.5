<div class="sidebar-inner slimscrollleft">
    ...
    <div id="sidebar-menu">
        <ul>
            ...
            <li><a href="<?php echo e(url('admin/verticals')); ?>"><i class="ti-layout-cta-left"></i> Verticals</a></li>
            <li><a href="<?php echo e(url('admin/products')); ?>"><i class="ti-layout-cta-left"></i> Products</a></li>
            <li><a href="<?php echo e(url('admin/tags')); ?>"><i class="fa fa-link"></i> Tags</a></li>
