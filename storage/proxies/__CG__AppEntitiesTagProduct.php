 ...
 */
class TagProduct extends \App\Entities\TagProduct implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\TagProduct' . "\0" . 'id', '' . "\0" . 'App\\Entities\\TagProduct' . "\0" . 'productId', '' . "\0" . 'App\\Entities\\TagProduct' . "\0" . 'tagId', '' . "\0" . 'App\\Entities\\TagProduct' . "\0" . 'status'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TagProduct $proxy) {
