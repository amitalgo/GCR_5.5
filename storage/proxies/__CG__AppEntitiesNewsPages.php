 ...
 */
class NewsPages extends \App\Entities\NewsPages implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\NewsPages' . "\0" . 'id', '' . "\0" . 'App\\Entities\\NewsPages' . "\0" . 'page', '' . "\0" . 'App\\Entities\\NewsPages' . "\0" . 'news', '' . "\0" . 'App\\Entities\\NewsPages' . "\0" . 'deleted', '' . "\0" . 'App\\Entities\\NewsPages' . "\0" . 'isActive', '' . "\0" . 'App\\Entities\\NewsPages' . "\0" . 'createdAt'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (NewsPages $proxy) {
