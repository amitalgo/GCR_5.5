 ...
 */
class FileSystem extends \App\Entities\FileSystem implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\FileSystem' . "\0" . 'id', '' . "\0" . 'App\\Entities\\FileSystem' . "\0" . 'path', '' . "\0" . 'App\\Entities\\FileSystem' . "\0" . 'originalName', '' . "\0" . 'App\\Entities\\FileSystem' . "\0" . 'fileName', '' . "\0" . 'App\\Entities\\FileSystem' . "\0" . 'type', '' . "\0" . 'App\\Entities\\FileSystem' . "\0" . 'tableName', '' . "\0" . 'App\\Entities\\FileSystem' . "\0" . 'tableKey', '' . "\0" . 'App\\Entities\\FileSystem' . "\0" . 'status', '' . "\0" . 'App\\Entities\\FileSystem' . "\0" . 'createDate', '' . "\0" . 'App\\Entities\\FileSystem' . "\0" . 'mimeType'];
        }
    ...
    public function getTableKey()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTableKey', []);

        return parent::getTableKey();
    }
    ...
    public function setTableKey($tableKey)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTableKey', [$tableKey]);

        return parent::setTableKey($tableKey);
    }
