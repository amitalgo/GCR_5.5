 ...
 */
class ScenarioTitle extends \App\Entities\ScenarioTitle implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\ScenarioTitle' . "\0" . 'id', '' . "\0" . 'App\\Entities\\ScenarioTitle' . "\0" . 'name', '' . "\0" . 'App\\Entities\\ScenarioTitle' . "\0" . 'priority', '' . "\0" . 'App\\Entities\\ScenarioTitle' . "\0" . 'deleted', '' . "\0" . 'App\\Entities\\ScenarioTitle' . "\0" . 'status', '' . "\0" . 'App\\Entities\\ScenarioTitle' . "\0" . 'addNo', '' . "\0" . 'App\\Entities\\ScenarioTitle' . "\0" . 'addDate', '' . "\0" . 'App\\Entities\\ScenarioTitle' . "\0" . 'updNo', '' . "\0" . 'App\\Entities\\ScenarioTitle' . "\0" . 'updDate', '' . "\0" . 'App\\Entities\\ScenarioTitle' . "\0" . 'scenarioDetail', '' . "\0" . 'App\\Entities\\ScenarioTitle' . "\0" . 'verticalImages'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ScenarioTitle $proxy) {
    ...
    public function getScenarioDetail()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getScenarioDetail', []);

        return parent::getScenarioDetail();
    }
    ...
    public function setScenarioDetail($scenarioDetail)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setScenarioDetail', [$scenarioDetail]);

        return parent::setScenarioDetail($scenarioDetail);
    }
    ...
    public function removeScenarioDetail($scenarioDetail)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeScenarioDetail', [$scenarioDetail]);

        return parent::removeScenarioDetail($scenarioDetail);
    }
    ...
    public function getVerticalImages()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getVerticalImages', []);

        return parent::getVerticalImages();
    }
    ...
    public function setVerticalImages($verticalImages)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setVerticalImages', [$verticalImages]);

        return parent::setVerticalImages($verticalImages);
    }
