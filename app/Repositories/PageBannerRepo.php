...
//    }
    ...
    public function getPageById($page_id){
        return $this->em->getRepository(Page::class)->find($page_id);
    }

     public function findVerticalBanner($id)
    {
        return $this->em->getRepository(VerticalImages::class)->findOneBy(['verticalId'=>$id]);
    }
}