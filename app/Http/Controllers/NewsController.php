...
class NewsController extends Controller
{
    ...
    public function __construct(AdService $adService,PageBannerService $pageBannerService,SolutionTypeService $solutionTypeService,ProductService $productService,NewsService $newsService,VerticalService $verticalService,TagService $tagService)
    {
    ...
    public function list(Request $request,$id)
    {
        ...
        $sortedData=$this->getDateWiseNews($news);
        $ads = $this->adService->getAdsByPage($this->page_id,2);
        return view('front-end.newslist',compact('banner','content','solutions','abouts','news','new','sortedData','ads'));
