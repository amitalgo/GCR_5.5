...
class Page
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="NewsPages", mappedBy="page")
     */
    private $pageId;

    /**
     * @ORM\OneToMany(targetEntity="AdsPages", mappedBy="pageAds" ,cascade={"persist"},fetch="EAGER")
     */
    private $pageAdsId;
     ...
     * @return mixed
     */
    public function getPageAdsId()
    {
        return $this->pageAdsId;
    }

    /**
     * @param mixed $pageAdsId
     */
    public function setPageAdsId($pageAdsId)
    {
        $this->pageAdsId = $pageAdsId;
    }
